...
function signIn() {
  // TODO 1: Sign into Firebase using popup auth & Google as the identity provider.
...
// Initiate firebase auth - Track the authentication state
function initFirebaseAuth() {
  // TODO 3: Listen to auth state changes.
